...
// patchGoogleConfig round-trips config.yaml through map[string]interface{} to
// inject Google OAuth credentials without disturbing other settings.
//
// WARNING: This approach is safe only because the config is freshly
// auto-generated by runDaemonSetup. It will lose YAML comments and may alter
// key ordering on an existing, hand-edited config. Do not reuse this pattern
// for user-written configs.
