ALTER TABLE tasks ADD COLUMN expected_tools_json TEXT NOT NULL DEFAULT '[]';
ALTER TABLE tasks ADD COLUMN expected_egress_json TEXT NOT NULL DEFAULT '[]';
...
ALTER TABLE audit_log ADD COLUMN used_active_task_context INTEGER NOT NULL DEFAULT 0;
ALTER TABLE audit_log ADD COLUMN used_lease_bias INTEGER NOT NULL DEFAULT 0;
ALTER TABLE audit_log ADD COLUMN used_conv_judge_resolution INTEGER NOT NULL DEFAULT 0;
ALTER TABLE audit_log ADD COLUMN would_block INTEGER NOT NULL DEFAULT 0;
ALTER TABLE audit_log ADD COLUMN would_review INTEGER NOT NULL DEFAULT 0;
ALTER TABLE audit_log ADD COLUMN would_prompt_inline INTEGER NOT NULL DEFAULT 0;
...
CREATE TABLE runtime_sessions (
    ...
    observation_mode          INTEGER NOT NULL DEFAULT 0,
