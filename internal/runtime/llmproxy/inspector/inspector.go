...
// placeholder we treat as plausibly real. Real placeholders generated by
// autovault.GeneratePlaceholder include a 32-char base64 random suffix
// on top of an `autovault_<service>_` prefix, so genuine tokens are
// always ≥44 chars. Anything shorter is a test stub, prose example, or
// documentation fragment — present in source files but not actually a
// vault reference. Used by AllPlaceholdersAreStubs to suppress
