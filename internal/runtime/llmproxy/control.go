...
func ControlNoticeWithCredentialHints(controlBaseURL string, availableTools []string, credentialHints []CredentialHint) string {
	...
	return strings.Join([]string{
		...
		"To discover available credential IDs, GET " + vaultItemsURL + ". Credential discovery does not require an approved task. The response is just IDs; read it directly and do not pipe or shell-filter it.",
